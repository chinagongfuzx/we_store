<template>
    <div>
        ...
        <div class="card">
			...
			<p class="price">市场价：<del>{{details.market_price}}</del> <font>销售价: <strong>{{details.sell_price}}</strong></font></p>
			<p class="count">购买数量 <van-stepper v-model="buyCount" min="1" /></p>
			<p class="btns"><van-button size="small" type="info">立即购买</van-button><van-button size="small" type="danger">加入购物车</van-button></p>
		</div>
        <div class="card">
			...
			<p class="line"></p>
			<p class="btn-big"><van-button plain type="info" v-on:click="toImgTxtDetaiks">图文介绍</van-button></p>
			<p class="btn-big"><van-button plain type="danger" v-on:click="toGoodsComment">商品评论</van-button></p>
		</div>
    </div>
</template>
