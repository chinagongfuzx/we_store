<template>
	<div>
		<van-grid :column-num="2" :border="false" use-slot>
			<van-grid-item v-for="(item, index) in goods" :key="index" v-on:click="toGoodDetails(item.id)">
				<div class="card">
					<img :src="item.img_url" alt="" v-on:error.once="img404">
